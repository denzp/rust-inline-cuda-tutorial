...
mod image {
    ...
    use std::ptr;
    use png::{BitDepth, ColorType, Decoder, DecodingError, Encoder, EncodingError, HasParameters};
    use super::Pixel;
    ...
    impl Image {
        ...
        pub fn save(&self, path: &str) -> Result<(), EncodingError> {
            ...
            let mut encoder =
                Encoder::new(BufWriter::new(file), self.width as u32, self.height as u32);
